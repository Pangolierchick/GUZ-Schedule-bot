...
class SchedulePool:
    ...
    def find_schedule_dir(self, schedule_name: str) -> str:
        ...
        raise ScheduleDirNotFound(
            f'Schedule dir not found for {schedule_name}')
    ...
    def find_group_subdir(self, group_path: str, subgroup: int):
        ...
        raise GroupDirNotFound(
            f'Group sub dir {subgroup} not found for {group_path}')
    ...
    def find_schedule_file(self, subgroup_path: str):
        ...
        raise ScheduleFileNotFound(
            f'Schedule file with {file_suffix} suffix not found')

    def load_schedule(
            self,
            groupname: str,
            subgroup: int) -> myschedule.GroupSchedule:
    ...
    def get_schedule(
        ...
        log.debug(
            f'Getting schedule for {schedule_name}. Current week type: {self.week_type}')
